...
namespace snowcrash
{
    ...
    struct SectionProcessor<Payload> : public SectionProcessorBase<Payload> {
        ...
        /**
         *  \brief  Assigns the reference, referred as reference id(name), into the
         * payload
        ...
        static void assingReferredPayload(SectionParserData& pd, const ParseResultRef<Payload>& out)
        {
            ...
            if (isPayloadContentType && isModelContentType) {
                ...
                // WARN: Ignoring payload content-type, when referencing a model with
                // headers
                std::stringstream ss;
            ...
            const MarkdownNodeIterator& node, SectionParserData& pd, const ParseResultRef<Payload>& out)
        {
            ...
            if (out.node.body.empty() && out.node.attributes.empty()
                ...
                // Warn when content-length or transfer-encoding is specified or headers,
                // parameters and body are empty
         ...
         *  \return Iterator pointing to the matching request within given method
         * requests.
         */
         ...
         *  \return Iterator pointing to the matching response within given method
         * requests.
         */
